...
public class StaffManagement {
    ...
    public void addTrainee(String name, String gender, int id, LocalDate startDate, LocalDate endDate) {
        Trainee newTrainee = new Trainee(name, gender, id, "trainee", startDate, endDate);
